...
import { Search, History, FilterX, ChevronLeft, ChevronRight, Eye } from 'lucide-react';
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 animate-fade-in">
      <div className="mb-6 hidden lg:block">
        <h1 className="text-xl font-bold text-gray-900 tracking-tight">Riwayat Transaksi Saya</h1>
        <p className="text-sm text-gray-500 mt-1">Daftar transaksi penjualan yang Anda lakukan</p>
      </div>
              ...
              {loading ? (
                ...
                transactions.map((tx, i) => (
                  <motion.tr key={tx.id} initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.02 }} className="hover:bg-gray-50/40 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      <button onClick={() => navigate(`/my-transactions/${tx.id}`, { state: { from: '/my-transactions' } })}
